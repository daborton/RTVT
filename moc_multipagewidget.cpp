...
**
** Created: Wed Feb 15 16:26:46 2012
...
const QMetaObject MultiPageWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MultiPageWidget,
      qt_meta_data_MultiPageWidget, 0 }
};
...
int MultiPageWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: addPage((*reinterpret_cast< QWidget*(*)>(_a[1]))); break;
        case 3: insertPage((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QWidget*(*)>(_a[2]))); break;
        case 4: removePage((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: setPageTitle((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 6: setCurrentIndex((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 7;
    }
